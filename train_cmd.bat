...
@REM python test_gen_images.py --dataset vimeo90K_septuplet --data_root ./vimeo_septuplet --load_from ckpts\saved_models_final\vimeo90K_septuplet\FlownetS-unet-noskipflow\model_best.pth --n_outputs 1 --exp_name FlownetS-unet-noskipflow-occ --num_workers 2