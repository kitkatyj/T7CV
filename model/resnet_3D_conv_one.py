...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        # Create the 1x1 convolution block at the beginning
        # self.stem = nn.Sequential(
        #     nn.Conv3d(3, 64, kernel_size=1, stride=1, padding=0, bias=False),  # Adjust the input channels (3 in this case) as needed
        #     batchnorm(64),  # Use the appropriate batch normalization layer
        #     nn.ReLU(inplace=True)
        # )
        ...
        # self.stem = nn.Sequential(
        #     nn.Conv3d(3, 3, kernel_size=1, stride=1, padding=0, bias=False),  
        #     batchnorm(3),  # Use the appropriate batch normalization layer
        #     nn.ReLU(inplace=True),
        ...
        self.stem = nn.Sequential(
            ...
            batchnorm(64),
            nn.ReLU(inplace=False),
            InceptionModule(64, 16, batchnorm=batchnorm)
        )
