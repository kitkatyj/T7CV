...
class UNet_3D_3D_lstm_middle(nn.Module):
    def __init__(self, block , n_inputs, n_outputs, batchnorm=False , joinType="concat" , upmode="transpose"):
        ...
        self.encoder = getattr(unet_3D , block)(pretrained=True , bn=batchnorm)            
        ...
        self.conv_lstm_middle = ConvLSTM(input_dim=4,  hidden_dim=3, kernel_size=(3,3),num_layers=1,batch_first=True, bias=True, return_all_layers=False)
    ...
    def forward(self, images):
        ...
        _, images_thru_lstm = self.conv_lstm_middle(images)
        h = images_thru_lstm[0][0]  
